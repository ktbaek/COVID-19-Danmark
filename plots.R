...
png("../figures/all_nu_pct.png", width = 20, height = 16, units = "cm", res = 300)
par(family = "lato", mar = c(5,8,1,2))

plot(data_total_2020$Date, data_total_2020$pct_confirmed, 
     type = "b", 
     pch = 19, 
     ylab = "", 
     xlab = "", 
...
text(x = as.Date("2020-05-20"), y = 18, labels = "Procent positive tests", col = "blue", cex = 1.5, font = 2)
dev.off()
...
png("../figures/all_nu_tests_negpos.png", width = 20, height = 16, units = "cm", res = 300)
par(family = "lato", mar = c(5,8,1,2))

plot(data_total_2020$Date, data_total_2020$negative, 
     type = "b", 
     pch = 19, 
     ylab = "", 
     xlab = "", 
...
points(data_total_2020$Date, data_total_2020$Confirmed, type = "b", pch = 19, col = "red", cex = 1.2)

text(x = as.Date("2020-05-03"), y = 21000, labels = "Antal negative tests", col = "#433880", cex = 1.5, font = 2)
text(x = as.Date("2020-06-08"), y = 2000, labels = "Antal positive tests", col = "red", cex = 1.5, font = 2)
dev.off()
