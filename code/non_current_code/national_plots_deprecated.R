...
axis(side = 4, col.axis = "black", las = 1, cex.axis = cex_axis, at = seq(0, max_pos + 1000, by = 1000), labels = paste0(seq(0, max_pos + 1000, by = 1000) / 100, " %"))
axis(side = 2, col.axis = "black", las = 1, cex.axis = cex_axis, at = seq(0, max_pos + 1000, by = 1000), labels = seq(0, max_pos + 1000, by = 1000))
...
y <- 3500
arrows(as.Date("2020-12-25"), y + max_pos/5, as.Date("2020-12-25"), y, lwd = 1, lend = 1, length = 0.1)
text(as.Date("2020-12-27"), y + max_pos/4.5, "Nedlukning 2.0", cex = 0.9, adj = 1)
