...
# b117 --------------------------------------------------------------------
  ...
  plot_data <- tests %>%
    ...
    mutate(share = positive * percent / 100,
           share_pct = positive * percent / tested,
  ...
  plot_data %>%
    ...
    labs(y = "Positivprocent", x = "Uge (startdato)", title = "Total positivprocent og estimeret positivprocent for B.1.1.7", caption = "Kristoffer T. Bæk, covid19danmark.dk, datakilde: covid19genomics.dk og SSI", subtitle = "Positivprocent for B.1.1.7 = antal positive \u00D7 antal B.1.1.7 genom / total antal genom / antal testede \u00D7 100") +
    standard_theme  +
    theme(plot.caption.position = "plot",
          axis.title.x = element_text(face = "bold", margin = margin(t = 0, r = 0, b = 8, l = 0)))
  ...
  plot_data %>%
    ...
    labs(y = "Positivprocent", x = "Uge (startdato)", title = "Estimeret positivprocent for B.1.1.7", caption = "Kristoffer T. Bæk, covid19danmark.dk, datakilde: covid19genomics.dk og SSI", subtitle = "Positivprocent for B.1.1.7 = antal positive \u00D7 antal B.1.1.7 genom / total antal genom / antal testede \u00D7 100") +
    standard_theme  +
    theme(plot.caption.position = "plot",
          axis.title.x = element_text(face = "bold", margin = margin(t = 0, r = 0, b = 8, l = 0)))
