...
plot_data %>%
 ...
 #geom_text(data = subset(plot_data, variable == "variant_abs_est"), aes(Date, value + 500  ,label = round(value, 0)), vjust=0, family = "lato", color = darken(pos_col,0.2), fontface = "bold", size = 2) +
  ...
  labs(
    y = "Antal positive",
    x = "Uge (startdato)", 
    title = "Ugentligt antal positivt testede og estimeret antal positive for B.1.1.7", 
    caption = standard_caption, 
    subtitle = "Estimeret antal B.1.1.7 = antal positive \u00D7 antal B.1.1.7 genom / total antal genom"
    ) +
  standard_theme  +
  theme(axis.title.x = element_text(face = "bold", margin = margin(t = 0, r = 0, b = 8, l = 0)))
...
plot_data %>%
  ...
  labs(
    y = "Positivprocent", 
    x = "Uge (startdato)", 
    title = "Total positivprocent og estimeret positivprocent for B.1.1.7", 
    caption = standard_caption, 
    subtitle = "Positivprocent for B.1.1.7 = antal positive \u00D7 antal B.1.1.7 genom / total antal genom / antal testede \u00D7 100"
    ) +
  standard_theme  +
  theme(axis.title.x = element_text(face = "bold", margin = margin(t = 0, r = 0, b = 8, l = 0)))
...
plot_data %>%
  ...
  scale_y_continuous(limits = c(0, NA)) +
  labs(y = "Positivprocent/Antal positive", x = "Startdato for uge", title = "Estimeret ugentlig udbredelse af B.1.1.7", caption = standard_caption, subtitle = "Antal positive med B.1.1.7 = antal positive \u00D7 antal B.1.1.7 genom / total antal genom\nPositivprocent for B.1.1.7 = antal positive med B.1.1.7 / antal testede \u00D7 100") +
  facet_theme  +
  theme(
...
plot_data %>%
  ...
  scale_x_date(labels = my_date_labels, date_breaks = "1 month") +
  scale_y_continuous(limits = c(0, NA)) +
  labs(y = "Positivprocent/Antal positive", x = "Startdato for uge", title = "Estimeret ugentlig udbredelse af hhv. B.1.1.7 og normale varianter", caption = standard_caption, subtitle = "Antal positive med B.1.1.7 = antal positive \u00D7 antal B.1.1.7 genom / total antal genom\nPositivprocent for B.1.1.7 = antal positive med B.1.1.7 / antal testede \u00D7 100") +
  facet_theme  +
  theme(
    legend.position = "none",
    plot.caption = element_text(size = 8),
...
p <- table_2_df %>%  
  ...
  labs(y = "Andel", x = "Uge (startdato)", title = "Andel af B.1.1.7 af alle varianter", caption = standard_caption) +
  standard_theme + 
