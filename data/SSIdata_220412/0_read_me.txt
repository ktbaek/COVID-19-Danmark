...
BEMÆRK: Fra d. 23/3-2022 indeholder filerne reinfektioner. Dog kører gennembrudsinfektionsfiler (se senere sektion) videre på en tidligere algoritme, som beregnede reinfektioner lidt anderledes i nogle filer og slet ikke i andre.
...
Bemærk: Disse filer er ikke opdateret til at køre med reinfektioner fra den nye algoritme, som trådte i kræft i de andre filer d. 23/3-2022.
...
Antallet af personer, cases og indlagte i gruppen anden vaccine er summen af personer, som har modtaget anden vaccine, personer med 2. stik med fuld effekt og med 3. stik med fuld effekt.
...
Et givent stik har fuld effekt 14 dage, efter vaccinen er givet. 
...
antal_personer_alle_Første vaccination: Antal personer som har modtaget første vaccine inklusiv tidligere positive (1. stik).
antal_personer_alle_Anden vaccination: Antal personer som har modtaget anden vaccine inklusiv tidligere positive (2. stik).
antal_personer_alle_Fuld vaccineeffekt: Antal personer som har opnået fuld vaccineeffekt (2. stik med fuld effekt) inklusiv tidligere positive.
antal_personer_Ingen vaccination: Antal personer uden vaccine.
antal_personer_Første vaccination: Antal personer som har modtaget første vaccine (1. stik).
antal_personer_Anden vaccination: Antal personer som har modtaget anden vaccine (2. stik).
antal_personer_Fuld vaccineeffekt: Antal personer som har opnået fuld vaccineeffekt (2. stik med fuld effekt).
antal_cases_Ingen vaccination: Antal personer testet positiv med covid-19 uden vaccine.
antal_cases_Første vaccination: Antal personer testet positiv med covid-19, som har modtaget første vaccine (1. stik).
antal_cases_Anden vaccination: Antal personer testet positiv med covid-19, som har modtaget anden vaccine (2. stik).
antal_cases_Fuld vaccineeffekt: Antal personer testet positiv med covid-19, som har opnået fuld vaccineeffekt (2. stik med fuld effekt).
antal_tests_Ingen vaccination: Antal personer testet med PCR for covid-19 (en test per uge) uden vaccine.
antal_tests_Første vaccination: Antal personer testet med PCR for covid-19 (en test per uge), som har modtaget første vaccine (1. stik).
antal_tests_Anden vaccination: Antal personer testet med PCR for covid-19 (en test per uge), som har modtaget anden vaccine (2. stik).
antal_tests_Fuld vaccineeffekt: Antal personer testet med PCR for covid-19 (en test per uge), som har opnået fuld vaccineeffekt (2. stik med fuld effekt).
antal_tests_total_Ingen vaccination: Antal personer testet med PCR for covid-19 (en test per dag) uden vaccine.
antal_tests_total_Første vaccination: Antal personer testet med PCR for covid-19 (en test per dag), som har modtaget første vaccine (1. stik).
antal_tests_total_Anden vaccination: Antal personer testet med PCR for covid-19 (en test per dag), som har modtaget anden vaccine (2. stik).
antal_tests_total_Fuld vaccineeffekt: Antal personer testet med PCR for covid-19 (en test per dag), som har opnået fuld vaccineeffekt (2. stik med fuld effekt).
...
antal_repositive_Første vaccination: Antal personer testet positiv med covid-19, som har modtaget første vaccine med >60 dage siden sidste positive prøve (1. stik).
antal_repositive_Anden vaccination: Antal personer testet positiv med covid-19, som har modtaget anden vaccine med >60 dage siden sidste positive prøve (2. stik).
antal_repositive_Fuld vaccineeffekt: Antal personer testet positiv med covid-19, som har opnået fuld vaccineeffekt (2. stik med fuld effekt) med >60 dage siden sidste positive prøve.
antal_indlagte_Ingen vaccination: Antal covid-19-relaterede indlæggelser blandt personer uden vaccine.
antal_indlagte_Første vaccination: Antal covid-19-relaterede indlæggelser blandt personer, som har modtaget første vaccine (1. stik).
antal_indlagte_Anden vaccination: Antal covid-19-relaterede indlæggelser blandt personer, som har modtaget anden vaccine (2. stik).
antal_indlagte_Fuld vaccineeffekt: Antal covid-19-relaterede indlæggelser blandt personer, som har opnået fuld vaccineeffekt (2. stik med fuld effekt).
...
Uge XX_Første vaccination: Antal personer testet positiv med covid-19, som har modtaget første vaccine (1. stik).
Uge XX_Anden vaccination: Antal personer testet positiv med covid-19, som har modtaget anden vaccine (2. stik).
Uge XX_Fuld vaccineeffekt: Antal personer testet positiv med covid-19, som har opnået fuld vaccineeffekt (2. stik med fuld effekt).
...
Uge XX_Første vaccination: Antal personer testet positiv med covid-19, som har modtaget første vaccine (1. stik) / antal personer i vaccinegruppe og aldersgruppe per mandag i Uge XX * 100 000.
Uge XX_Anden vaccination: Antal personer testet positiv med covid-19, som har modtaget anden vaccine (2. stik) / antal personer i vaccinegruppe og aldersgruppe per mandag i Uge XX * 100 000.
Uge XX_Fuld vaccineeffekt: Antal personer testet positiv med covid-19, som har opnået fuld vaccineeffekt (2. stik med fuld effekt) / antal personer i vaccinegruppe og aldersgruppe per mandag i Uge XX * 100 000.
...
Uge XX_Første vaccination: Antal personer testet positiv med covid-19, som har modtaget første vaccine (1. stik) inklusiv positive PCR prøver med >60 dage i mellem / antal personer (alle) i vaccinegruppe og aldersgruppe per mandag i Uge XX * 100 000.
Uge XX_Anden vaccination: Antal personer testet positiv med covid-19, som har modtaget anden vaccine (2. stik) inklusiv positive PCR prøver med >60 dage i mellem / antal personer (alle) i vaccinegruppe og aldersgruppe per mandag i Uge XX * 100 000.
Uge XX_Fuld vaccineeffekt: Antal personer testet positiv med covid-19, som har opnået fuld vaccineeffekt (2. stik med fuld effekt) inklusiv positive PCR prøver med >60 dage i mellem / antal personer (alle) i vaccinegruppe og aldersgruppe per mandag i Uge XX * 100 000.
